...
PpOp4           push hl         ;адрес следующего символа в строке
                ...
                sub #02
                ld (SPOp),a
                ;Старый код LDIR'ил `252-SPOp_new` байт со сдвигом стека —
                ;остаток от 254-байтового StackOp. В текущем 96-байтовом стеке
                ;это уезжало в StackNum/ComBuffer и портило операнды.
                ;Мы и так всегда снимаем именно верхушку (PpOp3 итеративно),
                ;поэтому сдвигать нечего.
